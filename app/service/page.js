...
const services = [
  {
    ...
    items: [
      ...
      "Thorough wear and tear inspection",
      "Expert spoke tightening and wheel truing (extra charges for new spokes)",
      "Comprehensive bearing inspection (replacement if needed, charges extra)",
      "Thread cleaning and maintenance",
      "Brake shoe inspection and cleaning (replacement charges extra)",
      "Complete component greasing",
      "Precise tire pressure adjustment",
      "Deep cleaning with wash and cleanser",
    ],
  },
  {
    ...
    items: [
      "Advanced fork, stem, and headset adjustment",
      "Professional component degreasing",
      "Detailed wear and tear analysis",
      "Expert spoke tensioning and wheel truing",
      "Comprehensive bearing system check",
      "Thread cleaning and maintenance",
      "Professional gear and disc brake tuning",
      "Brake pad inspection and cleaning",
      "Premium component greasing",
      "Precise tire pressure adjustment",
      "Deep cleaning with premium cleanser",
    ],
  },
  {
    title: "Home Service",
